...
- `THIRD_PARTY_NOTICES.md` is now generated by `npm run licenses` from the
  packages the panel and backend bundles actually carry, with each license text
  embedded. `npm run package:check` re-verifies the committed file and fails
  when it is missing, was generated for a different shared UI version, names a
  package that is no longer installed, disagrees with a package's declared
  license, or omits a runtime dependency that reaches the backend bundle.
...
- `@types/node` moved from 26.x to 22.x to match the supported Node 22.18
  runtime floor.
- The packaging check now permits a `prepack` lifecycle script and continues to
  reject `prepare`. Measured on npm 10.9 and 11.18, only `prepare` prints its
  banner into `npm pack --ignore-scripts` output, which is what corrupts the
  Signal K plugin-ci install simulation.
...
[0.7.2]: https://github.com/NearlCrews/signalk-openrouter-companion/compare/v0.7.1...v0.7.2
[0.7.1]: https://github.com/NearlCrews/signalk-openrouter-companion/compare/v0.7.0...v0.7.1
[0.7.0]: https://github.com/NearlCrews/signalk-openrouter-companion/compare/v0.6.1...v0.7.0
[0.6.1]: https://github.com/NearlCrews/signalk-openrouter-companion/compare/v0.6.0...v0.6.1
[0.6.0]: https://github.com/NearlCrews/signalk-openrouter-companion/compare/v0.5.7...v0.6.0
...
[0.4.2]: https://github.com/NearlCrews/signalk-openrouter-companion/compare/v0.4.1...v0.4.2
[0.4.1]: https://github.com/NearlCrews/signalk-openrouter-companion/compare/v0.4.0...v0.4.1
[0.4.0]: https://github.com/NearlCrews/signalk-openrouter-companion/compare/v0.3.2...v0.4.0
[0.3.2]: https://github.com/NearlCrews/signalk-openrouter-companion/compare/v0.3.1...v0.3.2
