...
// Coerce an unknown to a finite number, or null. Used when decoding history
// rows where a column may be a number, null, or an unexpected type, so
// non-finite values never enter arithmetic.
